...
const PreferencesContent = () => {
  ...
  const isSelected = (code) => i18n.language === code || i18n.language?.startsWith(code);
    ...
    <Box>
      ...
      >
        {LANGUAGES.map(({ code, label }) => (
          <MenuItem key={code} onClick={() => handleSelect(code)} selected={isSelected(code)}>
