...
module.exports = [
  { ignores: ['**/node_modules/**', '**/build/**', '**/coverage/**', '**/dist/**', '**/.nyc_output/**', '**/public/**'] },
  ...
  {
    files: ['server/**/*.test.js', 'server/testing/**/*.js', 'server/test-setup.js', 'server/test-utils.js'],
  ...
  // client workspace (React, JSX, ES modules)
  {
    ...
    languageOptions: {
      ...
      parserOptions: { requireConfigFile: false, babelOptions: { presets: ['@babel/preset-react'] }, ecmaVersion: 2022, sourceType: 'module', ecmaFeatures: { jsx: true } },
  ...
  {
    files: ['client/**/*.{test,spec}.{js,jsx}', 'client/src/testing/**/*.js', 'client/src/setupTests.js', 'client/src/jest-polyfills.js'],
