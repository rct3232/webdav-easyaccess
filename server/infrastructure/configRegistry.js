...
const CONFIG_ENTRIES = Object.freeze([
  ...
  { key: 'THUMBNAIL_TOKEN_SECRET', tier: TIER.T2, secret: true, default: 'thumbnail-secret', dbOnly: true },
  ...
  { key: 'LOGIN_RATE_LIMIT_WINDOW_MS', tier: TIER.T2, secret: false, default: 900000, dbOnly: true },
  ...
  { key: 'PERMISSIONS_EXISTENCE_INDEX_TTL_MS', tier: TIER.T2, secret: false, default: 30000, dbOnly: true },
  { key: 'PERMISSIONS_EXISTENCE_RECONCILE_BATCH_SIZE', tier: TIER.T2, secret: false, default: 100, dbOnly: true },
  { key: 'PERMISSIONS_EXISTENCE_RECONCILE_CONCURRENCY', tier: TIER.T2, secret: false, default: 4, dbOnly: true },
