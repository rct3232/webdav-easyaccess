...
const CONFIG_ENTRIES = Object.freeze([
  ...
  { key: 'MAX_THUMBNAIL_SIZE', tier: TIER.T1, secret: false, default: 300 },
  { key: 'THUMBNAIL_CONCURRENCY_LIMIT', tier: TIER.T1, secret: false, default: 10 },
  { key: 'THUMBNAIL_TOKEN_SECRET', tier: TIER.T1, secret: true, default: 'thumbnail-secret' },
  { key: 'THUMBNAIL_TOKEN_EXPIRY', tier: TIER.T1, secret: false, default: '15m' },
  { key: 'FFMPEG_PATH', tier: TIER.T1, secret: false },
  { key: 'FFMPEG_INIT_TIMEOUT_MS', tier: TIER.T1, secret: false, default: 2000 },
  { key: 'WEA_PREVIEW_TICKET_TTL_MS', tier: TIER.T1, secret: false, default: 120000 },
  ...
  { key: 'LOGIN_RATE_LIMIT_MAX', tier: TIER.T1, secret: false, default: 20 },
  { key: 'LOGIN_RATE_LIMIT_WINDOW_MS', tier: TIER.T1, secret: false, default: 900000 },
  ...
  // ── Email ──────────────────────────────────────────────────────────────
  { key: 'EMAIL_HOST', tier: TIER.T2, secret: false },
  { key: 'EMAIL_PORT', tier: TIER.T2, secret: false, default: 587 },
  { key: 'EMAIL_USER', tier: TIER.T2, secret: false },
  { key: 'EMAIL_PASSWORD', tier: TIER.T2, secret: true },
  { key: 'EMAIL_SECURE', tier: TIER.T2, secret: false, default: false },
  { key: 'EMAIL_FROM_NAME', tier: TIER.T2, secret: false, default: 'WebDAV EasyAccess' },
  ...
  { key: 'USER_CACHE_TTL_MS', tier: TIER.T1, secret: false, default: 3000 },
  { key: 'PERMISSION_CACHE_TTL_MS', tier: TIER.T1, secret: false, default: 5000 },
  { key: 'PERMISSIONS_EXISTENCE_INDEX_TTL_MS', tier: TIER.T1, secret: false, default: 30000 },
  { key: 'PERMISSIONS_EXISTENCE_RECONCILE_BATCH_SIZE', tier: TIER.T1, secret: false, default: 100 },
  { key: 'PERMISSIONS_EXISTENCE_RECONCILE_CONCURRENCY', tier: TIER.T1, secret: false, default: 4 },
