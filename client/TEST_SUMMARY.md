...
| `components/file-manager/__tests__/*.test.js` | BulkActionToolbar, DesktopPathBar, FileActionSheet, FileContextMenu, FileDetail, FileGrid, FileGridItem, FileList, FileListItem, FileManagerControls, FileManagerHeader, FileOperationProgress, FileSkeletons |
...
| `components/mobile/__tests__/*.test.js` | MobileBreadcrumb, MobileFAB |
