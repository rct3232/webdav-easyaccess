...
| `components/file-manager/__tests__/*.test.js` | BulkActionToolbar, Breadcrumb, FAB, FileActionSheet, FileContextMenu, FileDetail, FileGrid, FileGridItem, FileList, FileListItem, FileManagerControls, FileManagerHeader, FileOperationProgress, FileSkeletons |
